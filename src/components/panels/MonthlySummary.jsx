        ...
        <div className="flex flex-col gap-6 p-1">
            <div className="flex items-center justify-between">
                <div className="flex flex-col">
                    <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/95">Monthly Report</p>
            ...
            <div className="p-5 rounded-2xl bg-white/5 border border-pink-500/10">
                <div className="flex justify-between items-center mb-3">
                    <span className="text-[10px] font-bold uppercase tracking-widest text-white/90">Mission Efficiency</span>
                    <span className="text-lg font-mono font-bold text-white">{stats.efficiency}%</span>
                </div>
...
function StatCard({ label, value, icon, color, bg }) {
    return (
        <div className={`p-4 rounded-xl ${bg} border border-pink-500/10 flex flex-col gap-3 group hover:border-pink-500/30 transition-all`}>
            <div className={`${color} opacity-80 group-hover:opacity-100 transition-opacity`}>
                {icon}
            </div>
            <div>
                <p className="text-[9px] uppercase tracking-widest text-white/95 mb-0.5">{label}</p>
