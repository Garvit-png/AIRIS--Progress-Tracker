    ...
    return (
        <div className="grid grid-cols-3 gap-3">
            <div className="p-4 rounded-xl bg-white/5 border border-white/5">
                <p className="text-[9px] uppercase tracking-widest text-white/85 mb-1">Tasks</p>
            ...
            <div className="p-4 rounded-xl bg-pink-500/5 border border-pink-500/10">
                <p className="text-[9px] uppercase tracking-widest text-pink-500/40 mb-1">Proofs</p>
                <div className="flex items-end gap-2">
