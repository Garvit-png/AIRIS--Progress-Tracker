...
const BASE_COL_DELAY = 15;
const BASE_ROW_DELAY = 15;
const BASE_STEP_MS = 20;
...
const FlapCell = React.memo(function FlapCell({
  ...
  const topBg = "bg-neutral-900";
  const bottomBg = "bg-neutral-900";
  const textColor = "text-[#FF008C]";

  const flapTopBg = "bg-neutral-800";
  const flapTextColor = "text-[#FF008C]";
