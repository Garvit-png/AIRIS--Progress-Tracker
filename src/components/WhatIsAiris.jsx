...
const ACHIEVEMENTS = [
  { icon: '🥈', text: '2nd in Founders on the Loose at Ashoka University' },
  { icon: '🥉', text: '3rd in Capture the Flag at IIT Roorkee' },
  { icon: '🏅', text: 'Top 5 at National Entrepreneurship Challenge, IIT Bombay' },
  { icon: '🏆', text: 'Winners of Visual Vortex by GDG Rishihood University' },
  { icon: '💼', text: 'Paid UI/UX Internship at Inglu Global' },
]
